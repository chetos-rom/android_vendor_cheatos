...
ALARM_PATH := vendor/chetos/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/chetos/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/chetos/prebuilt/common/media/audio/ringtones
