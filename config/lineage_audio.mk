...
ALARM_PATH := vendor/cheatos/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/cheatos/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/cheatos/prebuilt/common/media/audio/ringtones
